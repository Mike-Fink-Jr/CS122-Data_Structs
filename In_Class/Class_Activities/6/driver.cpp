...
int main()
{
	...
	{ NULL,					// do the room last
	  ...
	  new Container("television", 60, 0),	// large television
	  new Container("stereo", 60, 0),	// large stereo
    ...
    // doing these separate, since they refer to other Things
    ...
    put( things[3], things[5] );		// empty bag still fits
